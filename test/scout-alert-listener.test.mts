 ...
 *   5. advanceAlertCursor — round-trip.
 *
 * The dispatch-audit-stream surface (recordDispatch, listDispatchAudits) was
 * extracted into ScoutDispatchAudit (issue #1972); its tests now live in
 * `test/scout-dispatch-audit.test.mts`.
 *
