/**
 * Retrospective Redis seam (epic #917). This module is the one typed accessor
 * for the persisted per-run retrospective ARTIFACTS (issue #921, retro-4) — the
 * durable, auditable record of what each retrospective concluded — that the
 * `/hydra-retro` skill reads and writes.
 *
 * ---------------------------------------------------------------------------
 * Persisted retrospective artifacts (issue #921, retro-4)
 * ---------------------------------------------------------------------------
 *
 * The skill owns the *durable record* of what each retrospective
