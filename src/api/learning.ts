...
//
// Issue #2216: co-located here, alongside its sole live consumer (the
// GET /learning/context-trace route below). This composition logic previously
// lived in src/learning.ts — a standalone module that earned its keep when the
