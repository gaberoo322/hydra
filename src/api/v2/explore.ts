...
export interface V2ExploreRouterDeps {
...
export function createV2ExploreRouter(deps: V2ExploreRouterDeps = {}) {
  const router = Router();
  ...
  // -------------------------------------------------------------------------
  router.get("/v2/explore/friction", async (_req, res) => {
    try {
  ...
  // -------------------------------------------------------------------------
  router.get("/v2/explore/behavior", async (req, res) => {
  ...
  // -------------------------------------------------------------------------
  router.get("/v2/explore/flow", async (req, res) => {
  ...
  // -------------------------------------------------------------------------
  router.get("/v2/explore/lessons", async (req, res) => {
  ...
  // -------------------------------------------------------------------------
  router.get("/v2/explore/anomalies", async (_req, res) => {
    try {
