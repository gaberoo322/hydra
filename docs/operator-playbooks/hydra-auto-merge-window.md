...
description: Dormant time-bounded auto-merger for a labeled bulk-PR campaign that, when a window is open, tiers and auto-merges the batch's eligible PRs and is audit-only otherwise.
