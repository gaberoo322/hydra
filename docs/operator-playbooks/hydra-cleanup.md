...
- `test/hydra-cleanup-emit.test.mts` — regression for the #1449/#1653/#1737 emit runner: title/body coherence (no hand-built title), deterministic demote-vs-delete classification, filter/dedup, module-dir grouping, chunking, batch-cap, ranking, recurrence, full-backlog coverage, and the namespace-import facade suppression (audited drops, file-kind untouched, #1724 acceptance scenario).
