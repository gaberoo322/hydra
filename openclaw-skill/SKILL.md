...
Goals are defined in `~/hydra/config/direction/goals.md` or editable via the dashboard. Edit to change success metrics, focus weights, constraints, and pain points.
...
| `~/hydra/config/direction/vision.md` | Operator vision (editable via dashboard) |
| `~/hydra/config/direction/priorities.md` | What Hydra should work on next (auto-generated by Director) |
| `~/hydra/config/direction/goals.md` | Project goals, metrics, focus weights |
| `~/hydra/config/feedback/to-planner.md` | Feedback for planner agent |
| `~/hydra/config/feedback/to-executor.md` | Feedback for executor agent |
