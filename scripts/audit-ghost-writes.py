...
WORKTREE_PREFIXES = (
    ...
    # hydra-betting worktrees moved off /dev/shm to <target>/web/.worktrees/
    # (issue #4177, prevention half of #4175) so node_modules resolves by
    # upward walk instead of a reach-back symlink to the main checkout.
